          ...
          child: Column(
            children: <Widget>[
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Flexible(
                      fit: FlexFit.loose,
                      child: Text(
                        AppLocalizations.of(context).translate('asw1'),
                        style: TextStyle(
                          color: Theme.of(context).accentColor,
              ...
              DropdownButtonFormField(
                decoration: InputDecoration(
                  labelText: AppLocalizations.of(context).translate('asw4'),
                ),
                validator: (value) {
                  if (value?.isEmpty ?? true) {
                    return AppLocalizations.of(context).translate('asw5');
                  }
                  return null;
                },
                value: shopCategory,
...
//                    ),
//                    label: Text(
//                      AppLocalizations.of(context).translate('asw10'),
...
//                  ),
                  RaisedButton.icon(
                    ...
                    label: Text(
                      AppLocalizations.of(context).translate('asw11'),
                      style: TextStyle(color: Colors.white),
                    ),
                    onPressed: () {
                      _saveForm();
