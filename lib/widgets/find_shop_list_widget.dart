...
class FindShopsList extends StatefulWidget {
  String sCategory;
  String sPlace;

  FindShopsList({this.sCategory, this.sPlace});

  @override
  _FindShopsListState createState() => _FindShopsListState();
}

class _FindShopsListState extends State<FindShopsList> {
